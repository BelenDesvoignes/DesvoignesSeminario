...
print ("Elegí  el nivel de dificultad.   1.💚💚💚Fácil   2.💛💛💛Media   3.❤️❤️❤️Difícil")
dificultad = (input ())
...
print(f"Palabra ▶️ {word_displayed}")
...
while (fallos != 10):
    ...
    if letter in guessed_letters:
        print(" ▶️ Ya has intentado con esa letra. Intenta con otra.")
        continue
    ...
    print (f"La palabra secreta era ▶️:", {secret_word})